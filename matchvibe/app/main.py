...
app.mount('/matchvibe/app/frontend/', StaticFiles(directory='matchvibe/app/frontend/'), name='frontend')
app.add_middleware(
    CORSMiddleware,
...
async def compare_images(file1: UploadFile, file2: UploadFile):
    try:
        ...
        raise HTTPException(status_code=500, detail='Error processing images') from e
